#!/usr/bin/env python3
"""
KuraliAll v2.0 — Python 版
全能 Linux 包管理器 | 纯 Python | 离线工作 | 跨发行版
"""
import os, sys, subprocess, shutil, tarfile, zipfile, tempfile, time, json, stat
...
def cmd_install(filepath, pkg_name=None, system_mode=False):
    ...
    # 保存元数据
    meta = {
        "name": pkg_name, "version": "unknown", "format": fmt,
...
# ─── 帮助 ───
HELP = """KuraliAll v2.0 — Python 版全能包管理器
...
支持: .deb  .rpm  .pkg.tar.*  AppImage  .tar.*  .zip
"""
